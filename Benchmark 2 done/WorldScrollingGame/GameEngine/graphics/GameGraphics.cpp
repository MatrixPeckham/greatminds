...
GameGraphics::~GameGraphics()
{
	...
	delete guiWorkingRenderList;
	delete worldWorkingRenderList;
...
void GameGraphics::swapRenderLists(){
	RenderList * temp = worldWorkingRenderList;
	worldWorkingRenderList = worldRenderList;
	worldRenderList=temp;
	temp = guiWorkingRenderList;
	guiWorkingRenderList = guiRenderList;
	guiRenderList=temp;
}