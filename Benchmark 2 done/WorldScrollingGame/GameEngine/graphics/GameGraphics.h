...
protected:
	...
	RenderList				*guiWorkingRenderList;
	RenderList				*worldWorkingRenderList;
...
public:	
	...
	RenderList*				getWorkingGUIRenderList()	{ return guiWorkingRenderList;	}
	TextureManager*			getGUITextureManager()		{ return guiTextureManager;		}
	RenderList*				getWorldRenderList()		{ return worldRenderList;		}
	RenderList*				getWorkingWorldRenderList()	{ return worldWorkingRenderList;}
	...
	virtual void			renderGameInRenderThread(Game * game)=0;
