...
void Viewport::checkAutoScroll(int w, int h) {
	if(autoScrollX) {
		moveViewport(scrollSpeedX,0, w, h);
	}
	if(autoScrollY) {
		moveViewport(0,scrollSpeedY, w,h);
	}
}
void Viewport::checkAutoScroll(int w, int h,int speed) {
	if(autoScrollX) {
		moveViewport(speed,0, w, h);
	}
	if(autoScrollY) {
		moveViewport(0,speed, w,h);
	}
}
